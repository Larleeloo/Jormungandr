...
import com.example.jormungandr.adapter.ActionAdapter;
import com.example.jormungandr.data.GameRepository;
import com.example.jormungandr.engine.CombatEngine;
import com.example.jormungandr.engine.LootGenerator;
import com.example.jormungandr.engine.PlayerLevelManager;
import com.example.jormungandr.model.ActionType;
import com.example.jormungandr.model.CombatCreature;
import com.example.jormungandr.model.CreatureDef;
...
import com.example.jormungandr.model.RoomObject;
import com.example.jormungandr.util.Constants;
import com.example.jormungandr.util.SeededRandom;
import com.example.jormungandr.view.CombatCanvasView;
...
public class CombatFragment extends Fragment implements ActionAdapter.OnActionClickListener {
    ...
    private void flee() {
        ...
        if (room != null && room.hasDoor(com.example.jormungandr.model.Direction.BACK)) {
            String backRoom = room.getDoorTarget(com.example.jormungandr.model.Direction.BACK);
            combatEngine.clearBuffs();
